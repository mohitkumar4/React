        ...
        <footer className='mt-5'>
            ...
            <div className='footer-content bg-black gap-3 px-3 px-lg-5 py-5'>
                <div className="f-content d-flex flex-wrap justify-content-space-between">
                    <div className="contacts w-20">
                        ...
                        <div className="opacity-75">
                            <div><i className="bi bi-geo-alt fd-color-primary me-2"></i>LPU, Jalandhar</div>
                            <div><i className="bi bi-phone fd-color-primary me-2"></i>+91 8341527085</div>
                            <div><i className="bi bi-envelope fd-color-primary me-2"></i>mohit398593@gmail.com</div>
                        </div>
                        <SocialsNetworks />
                    </div>
                ...
                <div className="d-flex flex-wrap justify-content-between">
                    ...
                    <p className="opacity-75">https://github.com/mohitkumar4</p>
                </div>
            </div>
        </footer>
    )
